...
https://github.com/axia-tech/substrate/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/axia-tech/substrate/blob/master/LICENSE[LICENSE]
