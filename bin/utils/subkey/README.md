...
You can read more about the SS58 format in the [substrate wiki](https://github.com/axia-tech/substrate/wiki/External-Address-Format-(SS58)) and see the list of reserved prefixes in the [AXIA wiki](https://wiki.axia.network/docs/build-ss58-registry).
